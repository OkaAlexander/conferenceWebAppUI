...
import { LoginThunk } from "../../functions/member";
...
export default function LoginPage() {
  ...
  const [form, setForm] = useState<{ email: string; id: string }>({
    email: "",
    id: "",
  });
  ...
  useEffect(() => {
    info && navigation("/uenr-conference/member");
  }, [info]);
  return (
